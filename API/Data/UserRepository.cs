...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<PageList<MembersDto>> GetMembersAsync(UserParams userParams)
        {
            ...
            return await PageList<MembersDto>.CreateAsync(query.ProjectTo<MembersDto>(_mapper.ConfigurationProvider).AsNoTracking(), userParams.PageNumber, userParams.PageSize);
        }
